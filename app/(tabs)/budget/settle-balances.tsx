...
const getStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  iconButton: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', backgroundColor: c.card, borderWidth: 1, borderColor: c.border },
  headerTitle: { fontSize: 18, fontWeight: '800', color: c.text },
  segmentWrap: { flexDirection: 'row', marginHorizontal: 20, padding: 4, borderRadius: radius.lg, borderWidth: 1, borderColor: c.border, backgroundColor: c.card },
  ...
  totalCard: { borderRadius: 18, borderWidth: 1, borderColor: c.border, backgroundColor: c.card, padding: 18, flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center' },
  totalCol: { flex: 1, minWidth: 120 },
  totalDivider: { width: 1, height: 54, backgroundColor: c.border, marginHorizontal: 14 },
  totalLabel: { fontSize: 12, fontWeight: '700', color: c.text2 },
  totalAmount: { fontSize: 28, fontWeight: '900', color: c.text, marginTop: 6 },
  ...
  cardList: { borderRadius: 18, borderWidth: 1, borderColor: c.border, backgroundColor: c.card, overflow: 'hidden' },
  ...
  outlineAction: { borderRadius: 14, borderWidth: 1, borderColor: c.accentBorder, paddingHorizontal: 12, paddingVertical: 8, backgroundColor: c.bg2 },
  ...
  securityNote: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 16, backgroundColor: c.success + '12', padding: 14 },
