-- Atomic flight replacement for itinerary rescans.
-- Avoids PostgREST schema-cache misses around arrival_time/arrive_time and
-- prevents deleting old flights unless the replacement insert succeeds.
